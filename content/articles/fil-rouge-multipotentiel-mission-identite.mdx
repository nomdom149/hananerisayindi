---
title: "Le fil rouge multipotentiel : quand la dispersion révèle une mission"
...
1. Ce que j'entends quand un client dit "je ne sais pas qui je suis vraiment"
2. Pourquoi la société a peur des multipotentiels
3. Ce qu'Emilie Wapnick et Barbara Sher ont nommé avant nous
4. Le fil rouge : un processus, pas un domaine
5. Comment je le détecte chez mes clients
6. Ce que ça change de l'avoir trouvé
7. Le puzzle éclaté n'était pas cassé
...
<div className="highlight">
  <p>Un multipotentiel ne change pas de mission. Il change de terrain d'expression. <strong>La mission, elle, reste la même.</strong></p>
</div>
...
<div className="highlight">
  <p>La légitimité d'un multipotentiel ne vient pas du nombre de domaines maîtrisés. <strong>Elle vient de la clarté avec laquelle il peut relier ces domaines à une direction qui lui appartient.</strong></p>
</div>
