...
<div className="sommaire">
  <p className="sommaire-eyebrow">Dans cet article</p>
  <ol>
    <li><a href="#s1">Ce que j'entends quand un client dit "je ne sais pas qui je suis vraiment"</a></li>
    <li><a href="#s2">Pourquoi la société a peur des multipotentiels</a></li>
    <li><a href="#s3">Ce qu'Emilie Wapnick et Barbara Sher ont nommé avant nous</a></li>
    <li><a href="#s4">Le fil rouge : un processus, pas un domaine</a></li>
    <li><a href="#s5">Comment je le détecte chez mes clients</a></li>
    <li><a href="#s6">Ce que ça change de l'avoir trouvé</a></li>
    <li><a href="#s7">Le puzzle éclaté n'était pas cassé</a></li>
  </ol>
</div>
...
<div className="img-seo">
  ...
  <figcaption>Le fil rouge multipotentiel : une direction constante derrière des formes changeantes.<br/><span style={{fontSize:"0.72rem"}}>© Hanane Risayindi</span></figcaption>
</div>
